...
namespace MGAChargerEcommerece.Helper
{
    public static class Helper
    {
        ...
        {
            return DateTime.Parse(DateTime.Now.AddHours(11).AddMinutes(30).ToString(), System.Globalization.CultureInfo.InvariantCulture);
        }
